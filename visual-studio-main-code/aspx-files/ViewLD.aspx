<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewLD.aspx.cs" Inherits="Project_Web.ViewLD" %>
...
<head runat="server">
    ...
    <style>
        ...
        *:after {
        ...
        .action-button {
            padding: 10px 15px;
            background-color: #f09819; /* Match the Login button color */
            color: white;
            border: none;
            border-radius: 5px;
            cursor: pointer;
        ...
        .action-button:hover {
            background-color: #ff512f; /* Match the Login button hover color */
        }
    </style>
</head>
<body>
